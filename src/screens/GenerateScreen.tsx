...
export const GenerateScreen = ({ navigation }: any) => {
  ...
  const [travelStyle, setTravelStyle] = useState<
    'solo' | 'casal' | 'familia' | 'amigos' | 'mochileiro'
  >('solo');
          ...
          <View style={styles.section}>
            ...
            <PlaceAutocomplete
              ...
              onPlaceSelected={(details) => {
                ...
                const image =
                  details.photoUrl || getCoverImageForDestination(details.city, details.country);
                setCoverImage(image);
              }}
              testID="generate-destination"
            />
            ...
            <View style={styles.optionsRow}>
              {budgetOptions.map((option) => (
                <TouchableOpacity
                  ...
                  testID={`generate-budget-${option.value}`}
                >
